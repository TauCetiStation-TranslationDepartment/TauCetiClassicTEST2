...
//admin proc
ADMIN_VERB(cmd_mentor_ticket_panel, (R_ADMIN|R_SERVER|R_MENTOR), "Mentor Ticket List", "Opens the list of mentor tickets", "Admin.Misc")
	var/browse_to
...
/client/proc/cmd_admin_ticket_panel()
	...
	if(!check_rights(R_ADMIN  |R_DEBUG, TRUE))
		return
	...
	global.tickets.BrowseTickets(browse_to)
